<?php
$link = "./payment.php" . "?" . $_SERVER['QUERY_STRING'];
?>
...
<body>
  <header class="header">
    <div class="header__container container">
      <a href="plan.html" class="header__logo"></a>
      <img src="img/logo.png" alt="logo" />
      </a>
      <a href="plan.html" class="btn">Получить план</a>
    </div>
  </header>
  ...
  <section class="results">
    <div class="container">
      <h1 class="results__title">
        Прогноз результатов программы на основе ваших ответов
      </h1>
    ...
    <div class="container">
      ...
      <div class="additional__item">
        ...
        <label for="additional1" class="additional__item-toggle">
          ...
          <svg class="additional__item-img" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M12 21C16.9706 21 21 16.9706 21 12C21 7.02944 16.9706 3 12 3C7.02944 3 3 7.02944 3 12C3 16.9706 7.02944 21 12 21Z" stroke="#F47B1B" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M9 12H15" stroke="#F47B1B" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M12 9V15" stroke="#F47B1B" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="additional__item-minus" />
          </svg>
        </label>
